  ...
  return (
    <main className="app">
      ...
      <div className="actions">
        <button onClick={() => createPdf({ data, result, lang: t, action: "save" })}>{t.pdf}</button>
        <button className="secondary" onClick={() => createPdf({ data, result, lang: t, action: "share" })}>{t.print}</button>
      </div>
    </main>
  );
}
